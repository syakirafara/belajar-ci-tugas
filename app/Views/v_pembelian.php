            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('pembelian/status/' . $item['id']) ?>" class="btn btn-primary btn-sm"
                                onclick="return confirm('Ubah status pesanan ini?')">
                                Ubah Status
                            </a>
                        </td>
                    </tr>
                        ...
                        <?php if (!empty($products[$item['id']])) : ?>
                            <?php foreach ($products[$item['id']] as $index2 => $item2) : ?>
                                ...
                                <?php if (!empty($item2['diskon']) && $item2['diskon'] > 0) : ?>
                                    <small class="text-muted">Diskon <?= number_to_currency($item2['diskon'], 'IDR') ?> / item</small><br>
                                <?php endif; ?>
